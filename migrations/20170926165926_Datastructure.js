 ...
 * @Date: 2017-09-26 16:59:53 
 * @Last Modified by: Prawee Wongsa
 * @Last Modified time: 2017-09-26 18:15:31
 */
exports.up = function(knex, Promise) {
  return knex.schema
    ...
    .createTable('birds', function( birdsTable ) {
        ...
        // Data
        // Each chainable method creates a column of the given type with the chained constraints. 
        // For example, in the line below, we create a column name `name` which has a maximum length of 250 characters,
        // is of type string (VARCHAR) and is not nullable.
        birdsTable.string('name', 250).notNullable();
        birdsTable.string('species', 250).notNullable();
        birdsTable.string('picture_url').notNullable();
